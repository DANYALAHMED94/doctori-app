...
class SignUpScreenOneForPatientScreen extends StatefulWidget {
  ...
  @override
  State<SignUpScreenOneForPatientScreen> createState() => _SignUpScreenOneForPatientScreenState();
}

class _SignUpScreenOneForPatientScreenState extends State<SignUpScreenOneForPatientScreen> {
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text("Log in ", style: CustomTextStyles.bodyMediumff004687,)
                      ],
                    ),
                  )
                ],
